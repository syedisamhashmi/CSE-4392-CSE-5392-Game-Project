...
var credits = [
    ...
    [
        ...
        {"txt": "         You can use the following text:", "type": "s"},
        {"txt": "         Music: https://www.chosic.com/free-music/all/", "type": "s"},
        {"txt": "zapsplat_foley_clothing_body_hit_punch_72693.mp3", "type": "s"},
        {"txt": "         You can use our sound effects in any non-commercial, commercial and broadcast production.", "type": "s"},
        {"txt": "         Sound from www.zasplat.com", "type": "s"},
        {"txt": "         You can use the following text:", "type": "s"},
        {"txt": "         Music: https://www.zapsplat.com/music/body-hit-punch-clothing/", "type": "s"},
        {"txt": "zapsplat_cartoon_frog_jump_26526.mp3", "type": "s"},
        {"txt": "         You can use our sound effects in any non-commercial, commercial and broadcast production.", "type": "s"},
        {"txt": "         Sound from www.zasplat.com", "type": "s"},
        {"txt": "         You can use the following text:", "type": "s"},
        {"txt": "         Music: https://www.zapsplat.com/music/cartoon-frog-jump/", "type": "s"},
