...
var ENEMY_TOMATO           = preload("res://entities/enemies/tomato/tomato.tscn")
...
func readMapData():
    ...
    if (
        ...
        for enemyData in levelData.enemies:
            ...
            elif enemyData.type == EntityTypeEnums.ENEMY_TYPE.TOMATO:
                newEnemy = ENEMY_TOMATO.instance()
                newEnemy.type = EntityTypeEnums.ENEMY_TYPE.TOMATO    
